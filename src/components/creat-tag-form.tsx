...
const createTagSchema = z.object({
    title: z.string().min(3, { message: 'Mínimus characters.'}),
})
    ...
    return (
        <form onSubmit={handleSubmit( createTag ) } className="w-full space-y-6">
            ...
            <div className="flex items-center justify-end gap-2">
                ...
                <Button 
                disabled={formState.isSubmitting} className="bg-teal-400 text-teal-950" type="submit">
                    {formState.isSubmitting ? <Loader2 className="size-3 animate-spin"/> 
